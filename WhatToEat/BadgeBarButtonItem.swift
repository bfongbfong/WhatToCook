...
public class BadgeBarButtonItem: UIBarButtonItem
{
    ...
    private func updateBadge()
    {
        ...
        if self.badgeNumber > 0 && self.label.superview == nil
        {
            ...
            self.label.widthAnchor.constraint(equalToConstant: 22).isActive = true
            self.label.heightAnchor.constraint(equalToConstant: 22).isActive = true
            self.label.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 17).isActive = true
